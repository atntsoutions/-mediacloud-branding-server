...
{
    public class MBLReport : BaseReport
    {
        ...
        private void FillData()
        {
            ...
            ROW_HT = 16; R1++;
            Row += ROW_HT + 5; R1++;
           // AddXYLabel(HCOL1, Row, ROW_HT + ROW_HT, HCOL7 - HCOL1, "Multimodal Transport Document", ifontName, 18, "LTR" + dColr, "BC" + dColr, R1, XL_COLA, 0, 20, 16, 0, 0, 22);//GlobalConstants.Address_Line1
            AddXYLabel(HCOL1, Row, ROW_HT + ROW_HT, HCOL7 - HCOL1, "Draft Bill of Lading", ifontName, 18, "LTR" + dColr, "BC" + dColr, R1, XL_COLA, 0, 20, 16, 0, 0, 22);//GlobalConstants.Address_Line1
            Row += ROW_HT; R1++;
            Row += ROW_HT; R1++;
            AddXYLabel(HCOL1, Row, ROW_HT, HCOL5 - HCOL1, "Shipper", ifontName, ifontSizesm, "LT" + dColr, "" + dColr, R1, XL_COLA, 4, 16, 0, 0, Xtolrnce);
           // AddXYLabel(HCOL5, Row, ROW_HT + 5, HCOL7 - HCOL5, mRow.bl_reg_no, ifontName, ifontSize + 2, "TLRB" + dColr, "CB" + dColr, R1, XL_COLF, 0, 16, 0, 0, 0, 11);
            AddXYLabel(HCOL5, Row, ROW_HT + 5, HCOL7 - HCOL5, "", ifontName, ifontSize + 2, "TLR" + dColr, "CB" + dColr, R1, XL_COLF, 0, 16, 0, 0, 0, 11);
            ...
            AddXYLabel(HCOL5, Row, ROW_HT, (HCOL6) - HCOL5, "", ifontName, ifontSize, "L" + dColr, "", R1, XL_COLF, 5, 16);
            AddXYLabel(HCOL6, Row, ROW_HT, HCOL7 - (HCOL6), "", ifontName, ifontSize, "R" + dColr, "", R1, XL_COLG, 4, 16);

            //AddXYLabel(HCOL5 - 20, Row + 8, ROW_HT + 5, (HCOL6 - 30) - (HCOL5 - 20), "MTD Number ", ifontName, ifontSize + 2, "", "RB" + dColr, R1, XL_COLF, 5, 16, 0, 0, 0, 11);
            //AddXYLabel(HCOL6 - 30, Row + 8, ROW_HT + 5, 10, ":", ifontName, ifontSize, "", "CB" + dColr, R1, XL_COLG, 4, 16);
            //str = mRow.hbl_bl_no;
            //if (InvokeType == "DRAFT")
            //    str = "";
            //AddXYLabel(HCOL6 - 18, Row + 8, ROW_HT + 5, HCOL7 - (HCOL6 - 10), str, ifontName, ifontSize + 4, "LTRB" + dColr, "C1", R1, XL_COLG, 4, 16, 0, 0, 0, 16);
            ...
            AddXYLabel(HCOL5, Row, ROW_HT, (HCOL6) - HCOL5, "", ifontName, ifontSize, "L" + dColr, "R", R1, XL_COLF, 5, 16);
            AddXYLabel(HCOL6, Row, ROW_HT, HCOL7 - (HCOL6), "", ifontName, ifontSizesm, "R" + dColr, "C", R1, XL_COLG, 4, 16);
            ...
            AddXYLabel(HCOL5, Row, ROW_HT, HCOL7 - HCOL5, "", ifontName, ifontSizesm, "LR" + dColr, "", R1, XL_COLF, 5, 16);

            float sRow = Row + 15, sRow_HT = 20;
            ...
            Row += ROW_HT; R1++;
            AddXYLabel(HCOL1, Row, ROW_HT, HCOL5 - HCOL1, " Notify Party", ifontName, ifontSizesm, "LT" + dColr, "" + dColr, R1, XL_COLA, 4, 16, 0, 0, Xtolrnce);
            AddXYLabel(HCOL5, Row, ROW_HT, HCOL7 - HCOL5, "", ifontName, ifontSizesm, "" + dColr, "", R1, XL_COLF, 5, 16);
            ...
            AddXYLabel(HCOL5, Row, ROW_HT, HCOL7 - HCOL5, "", ifontName, ifontSizesm, "LR" + dColr, "" + dColr, R1, XL_COLF, 5, 16, 0, 0, Xtolrnce);//To obtain delivery contact
            ...
            Row += ROW_HT; R1++;
            AddXYLabel(HCOL1, Row, ROW_HT + 5, HCOL5 - HCOL1, "Port of Loading", ifontName, ifontSizesm, "LT" + dColr, "" + dColr, R1, XL_COLA, 2, 16, 0, 0, Xtolrnce);
            ...
            AddXYLabel(HCOL5, Row, ROW_HT + 5, HCOL7 - HCOL5, "Place of Receipt", ifontName, ifontSizesm, "LTR" + dColr, "", R1, XL_COLF, 5, 16, 0, 0, Xtolrnce);


            Row += ROW_HT + 5; R1++;

            int NewfszPdf = ifontSize + 2;
            int Newfsz = NewFontsize((int)(HCOL5 - HCOL1), mRow.bl_pol.ToString(), ifontName, ifontSize, out NewfszPdf);
            AddXYLabel(HCOL1, Row, ROW_HT, HCOL5 - HCOL1, mRow.bl_pol.ToString(), ifontName, Newfsz, "L" + dColr, "", R1, XL_COLA, 2, 16, 0, 0, Xtolrnce, NewfszPdf);
            ...
            //AddXYLabel(HCOL2, Row, ROW_HT, HCOL4 - HCOL2, mRow.bl_date_receipt_print, ifontName, ifontSize, "" + dColr, "", R1, XL_COLD, 0, 16, 0, 0, Xtolrnce, ifontSize + 2);

            //NewfszPdf = ifontSize + 2;
            //Newfsz = NewFontsize((int)(HCOL5 - HCOL4), mRow.bl_pol.ToString(), ifontName, ifontSize, out NewfszPdf);
            //AddXYLabel(HCOL4, Row, ROW_HT, HCOL5 - HCOL4, mRow.bl_pol.ToString(), ifontName, Newfsz, "" + dColr, "", R1, XL_COLE, 0, 16, 0, 0, Xtolrnce, NewfszPdf);
            NewfszPdf = ifontSize + 2;
            Newfsz = NewFontsize((int)(HCOL7 - HCOL5), mRow.bl_place_receipt.ToString(), ifontName, ifontSize, out NewfszPdf);
            AddXYLabel(HCOL5, Row, ROW_HT, HCOL7 - HCOL5, mRow.bl_place_receipt.ToString(), ifontName, Newfsz, "LR" + dColr, "", R1, XL_COLE, 0, 16, 0, 0, Xtolrnce, NewfszPdf);

            Row += ROW_HT; R1++;
            AddXYLabel(HCOL1, Row, ROW_HT + 5, (HCOL5) - HCOL1, "Port of Discharge", ifontName, ifontSizesm, "LT" + dColr, "" + dColr, R1, XL_COLA, 2, 16, 0, 0, Xtolrnce);
            ...
            AddXYLabel(HCOL5, Row, ROW_HT + 5, HCOL7 - HCOL5, "Place of Delivery", ifontName, ifontSizesm, "TLR" + dColr, "", R1, XL_COLF, 5, 16, 0, 0, Xtolrnce);

            Row += ROW_HT + 5; R1++;
            NewfszPdf = ifontSize + 2;
            Newfsz = NewFontsize((int)((HCOL5) - HCOL1), mRow.bl_pod.ToString(), ifontName, ifontSize, out NewfszPdf);
            AddXYLabel(HCOL1, Row, ROW_HT, (HCOL5) - HCOL1, mRow.bl_pod.ToString(), ifontName, Newfsz, "L" + dColr, "", R1, XL_COLA, 2, 16, 0, 0, Xtolrnce, NewfszPdf);

            //NewfszPdf = ifontSize + 2;
            //Newfsz = NewFontsize((int)(HCOL5 - (HCOL3 - 25)), mRow.bl_place_delivery.ToString(), ifontName, ifontSize, out NewfszPdf);
            //AddXYLabel(HCOL3 - 25, Row, ROW_HT, HCOL5 - (HCOL3 - 25), mRow.bl_place_delivery.ToString(), ifontName, Newfsz, "" + dColr, "", R1, XL_COLD, 1, 16, 0, 0, Xtolrnce, NewfszPdf);
            NewfszPdf = ifontSize + 2;
            Newfsz = NewFontsize((int)(HCOL7 - (HCOL5)), mRow.bl_place_delivery.ToString(), ifontName, ifontSize, out NewfszPdf);
            AddXYLabel(HCOL5, Row, ROW_HT, HCOL7 - (HCOL5), mRow.bl_place_delivery.ToString(), ifontName, Newfsz, "LR" + dColr, "", R1, XL_COLD, 1, 16, 0, 0, Xtolrnce, NewfszPdf);

            Row += ROW_HT; R1++;
            AddXYLabel(HCOL1, Row, ROW_HT + 5, (HCOL4 + 25) - HCOL1, "Vessel And Voyage No.", ifontName, ifontSizesm, "LT" + dColr, "" + dColr, R1, XL_COLA, 2, 16, 0, 0, Xtolrnce);
            ...
            Row += ROW_HT; R1++;
            AddXYLabel(HCOL1, Row, ROW_HT, HCOL2 - HCOL1, "Container No(s)", ifontName, ifontSizesm, "L" + dColr, "C" + dColr, R1, XL_COLA, 0, 16);
            AddXYLabel(HCOL2, Row, ROW_HT, HCOL4 - HCOL2, "Marks and Numbers", ifontName, ifontSizesm, "", "C" + dColr, R1, XL_COLB, 1, 16);
            AddXYLabel(HCOL4, Row, ROW_HT, HCOL6 - HCOL4, "Number of packages, kinds of packages, general", ifontName, ifontSizesm, "", "C" + dColr, R1, XL_COLD, 2, 16);
            AddXYLabel(HCOL6, Row, ROW_HT, (HCOL6 + 100) - HCOL6, "Gross Weight", ifontName, ifontSizesm, "", "L" + dColr, R1, XL_COLG, 2, 16);
            AddXYLabel(HCOL6 + 100, Row, ROW_HT, HCOL7 - (HCOL6 + 100), "Measurement", ifontName, ifontSizesm, "R" + dColr, "L" + dColr, R1, XL_COLJ, 1, 16);
          ...
          //  AddXYLabel(HCOL6, sRow, ROW_HT, HCOL7 - HCOL6, "NET.WT / KGS", ifontName, ifontSize, "", "", R1, XL_COLA, XL_COL_TOT, 16, 0, 0, 0, ifontSize + 2);
            ...
            Row += ROW_HT + 4; R1++;
            AddXYLabel(HCOL1, Row, ROW_HT, HCOL3 - HCOL1, "Number of BALES& CTNS", ifontName, ifontSizesm, "LT" + dColr, "" + dColr, R1, XL_COLA, 2, 16, 0, 0, Xtolrnce);
            AddXYLabel(HCOL3, Row, ROW_HT, (HCOL5 + 45) - HCOL3, "", ifontName, ifontSizesm, "T" + dColr, "" + dColr, R1, XL_COLD, 1, 16, 0, 0, Xtolrnce);
            AddXYLabel(HCOL5 + 45, Row, ROW_HT, HCOL6 - (HCOL5 + 45), "Movement", ifontName, ifontSizesm, "TL" + dColr, "" + dColr, R1, XL_COLF, 1, 16, 0, 0, Xtolrnce);
            AddXYLabel(HCOL6, Row, ROW_HT, HCOL7 - HCOL6, "Freight", ifontName, ifontSizesm, "TLR" + dColr, "" + dColr, R1, XL_COLH, 3, 16, 0, 0, Xtolrnce);
            Row += ROW_HT; R1++;
            AddXYLabel(HCOL1, Row, ROW_HT, HCOL3 - HCOL1, "", ifontName, ifontSize, "L" + dColr, "", R1, XL_COLA, 2, 16);
            AddXYLabel(HCOL3, Row, ROW_HT, (HCOL5 + 45) - HCOL3, "", ifontName, ifontSize, "" + dColr, "", R1, XL_COLD, 1, 16);
            ...
            str = "";
            str = mRow.bl_desc2;
            AddXYLabel(HCOL1, Row, ROW_HT, HCOL5 - HCOL1, str, ifontName, ifontSize, "L" + dColr, "L", R1, XL_COLA, 2, 16, 0, 0, Xtolrnce, ifontSize + 2);
            AddXYLabel(HCOL3, Row, ROW_HT, (HCOL5 + 45) - HCOL3, "", ifontName, ifontSize, "" + dColr, "C", R1, XL_COLD, 1, 16, 0, 0, 0, ifontSize + 2);


            //str = getCopy(mRow.bl_no_copies.ToString());
            str = mRow.bl_issued_place.ToString();
            AddXYLabel(HCOL5 + 45, Row, ROW_HT, HCOL6 - (HCOL5 + 45), str, ifontName, ifontSize, "L" + dColr, "L", R1, XL_COLF, 1, 16, 0, 0, Xtolrnce, ifontSize + 2);
            //str = mRow.bl_issued_place.ToString() + " " + Lib.DatetoStringDisplayformat(mRow.bl_issued_date);
            str = mRow.bl_frt_pay_at;
          

            AddXYLabel(HCOL6, Row, ROW_HT, HCOL7 - HCOL6, str, ifontName, ifontSize, "LR" + dColr, "L", R1, XL_COLH, 3, 16, 0, 0, Xtolrnce, ifontSize + 2);
            ...
            AddXYLabel(HCOL6 - 100, Row, ROW_HT, HCOL7 - (HCOL6 - 100), "", "Times New Roman", ifontSize + 2, "TR" + dColr, "BR" + dColr, R1, XL_COLH, 3, 16);
            //AddXYLabel(HCOL6 - 100, Row + 3, ROW_HT, HCOL7 - (HCOL6 - 90), "For CARGOMAR PVT. LTD.", "Times New Roman", ifontSize + 2, "", "BR" + dColr, R1, XL_COLH, 3, 16, 0, 0, 0, 12);
            Row += ROW_HT; R1++;
            ...
            AddXYLabel(HCOL6 - 100, Row, ROW_HT, HCOL7 - (HCOL6 - 100), "", ifontName, ifontSize, "R" + dColr, "", R1, XL_COLH, 3, 16);
            Row += ROW_HT; R1++;
            ...
            AddXYLabel(HCOL1, Row, ROW_HT, (HCOL6 - 110) - HCOL1, "", ifontName, ifontSizesm, "", "R" + dColr, R1, XL_COLA, 2, 16);
            AddXYLabel(HCOL6 - 100, Row, ROW_HT, HCOL7 - (HCOL6 - 100), "", ifontName, ifontSizesm, "BR" + dColr, "R", R1, XL_COLH, 3, 16);
            AddXYLabel(HCOL6 - 100, Row, ROW_HT, HCOL7 - (HCOL6 - 90), "", ifontName, ifontSizesm, "", "R" + dColr, R1, XL_COLH, 3, 16);
            /*
            if (Chk_BL_Original == false)
            {
                if (InvokeType == "DRAFT")
