...
namespace DataBase
{
    ...
    {
        public Image Resize(Image image, int newWidth, int newHeight, string message)
        {
            try
            {
                Image newImage = new Bitmap(newWidth, Calculations(image.Width, image.Height, newWidth));
